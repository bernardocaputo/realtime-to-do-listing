...
config :realtime_to_do_listing, RealtimeToDoListingWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: RealtimeToDoListingWeb.ErrorHTML, json: RealtimeToDoListingWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: RealtimeToDoListing.PubSub,
  live_view: [signing_salt: "5IokPQ6t"]
